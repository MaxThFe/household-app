...
A household management PWA built for two people. It covers meal planning with a shared recipe book, a collaborative shopping list, a calendar that syncs work shifts from an ICS feed, and live room temperature and humidity.
